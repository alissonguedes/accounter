...
export class HttpService {
	...
	get<T>(endpoint: string, params?: any): Observable<T> {
		...
		params = !!params && typeof params !== 'undefined' ? Object.assign(params, { id_usuario: usuario }) : null;
		return this.http
	...
	post<T>(endpoint: string, body: any): Observable<T> {
		...
		const usuario = localStorage.getItem('id');
		body = !!body && typeof body !== 'undefined' ? Object.assign(body, { id_usuario: usuario }) : null;
		return this.http
